...
class device{
	...
	public static $func_whitelist = array("");

	/**
	*	Returns the user device
	* 	The code used on this method comes from http://detectmobilebrowsers.mobi/
	*   and is expected to be used only on non-commercial websites. if you are
	*   using this in a commercial website please attend to the website http://detectmobilebrowsers.mobi/
	*   for their terms.
	**/
	public static function getType(){
		$iphone=true;$android=true;$opera=true;$blackberry=true;$palm=true;$windows=true;$mobileredirect=false;$desktopredirect=false;
